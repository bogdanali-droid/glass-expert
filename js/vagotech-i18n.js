...
(function () {
  ...
  var DICT = {
    en: {
      ...
      'hero.eyebrow': 'EN 15152 · EN 15153 · EN 12600 · EN 45545',
      'hero.h1': 'VAGOTECH — Railway & Tramway Glass',
      'hero.subtitle': 'Certified. Precision-Engineered. Delivered in 4–6 Weeks.',
      'hero.body': 'Rail-grade glass for CFR, STB, Electroputere and Astra Vagoane — engineered to European safety standards, manufactured in-house, and delivered on a schedule your fleet planners can rely on. 25+ years of glass engineering from one of Europe\'s Top 20 processors.',
      ...
      'hero.stat.top20': 'EU glass processor', 'hero.stat.en45545': 'Fire & smoke compliant builds',
      'strip.en15152': 'EN 15152 Windscreens', 'strip.en15153': 'EN 15153 Side & Door Glass',
      'strip.en12600': 'EN 12600 Impact Safety', 'strip.en45545': 'EN 45545 Fire & Smoke',
      ...
      'story.p2': '<strong>Why now.</strong> Romania\'s rail network is in the middle of its largest modernization in decades. CFR C&#259;l&#259;tori is introducing new Alstom Coradia Stream electric trainsets and Traxx locomotives. Bucharest\'s STB has deployed new trams and has contracted dozens more. Hungary\'s M&#193;V is replacing aging EMU fleets. New rolling stock and refurbishment programmes across 7 countries all share one requirement: engineered, dimensionally exact glass delivered on a dependable schedule.',
      'story.p3': '<strong>The challenge operators face.</strong> Rail glass must survive thermal cycling, vibration, impact and decades of daily duty &mdash; while meeting non-negotiable European standards: EN&nbsp;15152 for windscreens, EN&nbsp;15153 for side and door glass, EN&nbsp;12600 for impact performance, and &mdash; critically for EU tendering &mdash; EN&nbsp;45545 for fire and smoke behaviour. A single compliance gap or a slipped delivery can hold an entire vehicle in the workshop. Operators need a partner that treats glass as a precision component, not a commodity.',
      'story.p4': '<strong>The VAGOTECH advantage.</strong> In-house tempering, lamination, curved shaping and custom edge work mean no outsourcing and no compromises. We engineer to exact OEM and operator specifications, document full compliance including EN&nbsp;45545, and deliver in 4–6 weeks &mdash; against the industry standard of 12–16 weeks from larger European suppliers. European quality, regional proximity, single-supplier accountability.',
      ...
      'prod.ws.solution': '<strong>VAGOTECH solution:</strong> Laminated, heat-strengthened glass engineered to EN&nbsp;15152. Custom curvature to OEM cab geometry. Optional heating layer for de-icing, UV-protective and acoustic interlayers. EN&nbsp;45545 fire & smoke compliant builds available.',
      'prod.ws.spec1': '<strong>Standard:</strong> EN&nbsp;15152 (rail windscreens) + EN&nbsp;45545',
      ...
      'prod.sd.solution': '<strong>VAGOTECH solution:</strong> Tempered or laminated glazing to EN&nbsp;15153 and EN&nbsp;12600 impact class. EN&nbsp;45545 compliant builds available where required for EU tendering. Custom dimensions, curves and angles for any car type.',
      'prod.sd.spec1': '<strong>Standard:</strong> EN&nbsp;15153 + EN&nbsp;12600 + EN&nbsp;45545',
      ...
      'prod.int.solution': '<strong>VAGOTECH solution:</strong> Tempered or laminated interior glass to EN&nbsp;12600 impact classification and EN&nbsp;45545 fire behaviour. Clear, frosted or tinted finishes. Anti-scratch coatings. Lightweight builds for vehicle efficiency.',
      'prod.int.spec1': '<strong>Standard:</strong> EN&nbsp;12600 + EN&nbsp;45545 (fire & smoke)',
      ...
      'prod.cust.solution': '<strong>VAGOTECH solution:</strong> Full engineering consultation from drawing to delivery. Any shape, size or build. Documented testing and compliance including EN&nbsp;45545 where applicable. Dedicated project management for fleet-scale orders.',
      ...
      'prod.cust.spec3': '<strong>Compliance:</strong> Full EN documentation incl. 45545',
      ...
      'comp.row2.label': 'EN 45545 (fire & smoke)', 'comp.row2.vago': '✓ Compliant builds',
      ...
      'comp.row6.label': 'Regional proximity (RO/HU/RS/BG)', 'comp.row6.large': '✗ UK / FR', 'comp.row6.dist': '✗ SE / UK', 'comp.row6.vago': '✓ Timi&#537;oara, Romania',
      ...
      'cred.stat3': 'Delivery (vs. 12–16 industry avg.)', 'cred.stat4': 'Rail standards incl. 45545',
      ...
      'compl.en45545.label': 'EU Tendering Prerequisite',
      'compl.en45545.p': 'Fire behaviour & smoke toxicity — required for EU rail operator tenders',
      ...
      'form.req.placeholder': 'Vehicle type (locomotive, EMU, tram, wagon), glass application, approx. dimensions or drawing reference, vehicle count, EN 45545 requirement (yes/no), target delivery timeline...',
      ...
      'footer.copyright': '© 2026 VAGOTECH by Glas Expert. All rights reserved.  |  EN 15152  ·  EN 15153  ·  EN 12600  ·  EN 45545',
    },
    ...
    ro: {
      ...
      'hero.stat.top20': 'Producător EU sticlă', 'hero.stat.en45545': 'Conformitate EN 45545 foc & fum',
      'strip.en15152': 'EN 15152 Parbrize', 'strip.en15153': 'EN 15153 Geam lateral și ușă',
      'strip.en12600': 'EN 12600 Siguranță la impact', 'strip.en45545': 'EN 45545 Foc și fum',
      ...
      'prod.ws.solution': '<strong>Soluția VAGOTECH:</strong> Sticlă laminată, termoîntărită, proiectată conform EN&nbsp;15152. Curbură personalizată la geometria cabinei OEM. Strat de încălzire opțional pentru dezghețare, folii de protecție UV și acustice. Execuții conforme EN&nbsp;45545 disponibile.',
      'prod.ws.spec1': '<strong>Standard:</strong> EN&nbsp;15152 (parbrize feroviare) + EN&nbsp;45545',
      ...
      'prod.sd.solution': '<strong>Soluția VAGOTECH:</strong> Sticlă securizată sau laminată conform EN&nbsp;15153 și clasă de impact EN&nbsp;12600. Execuții conforme EN&nbsp;45545 disponibile unde se impun pentru licitații UE. Dimensiuni, curbe și unghiuri personalizate pentru orice tip de vehicul.',
      'prod.sd.spec1': '<strong>Standard:</strong> EN&nbsp;15153 + EN&nbsp;12600 + EN&nbsp;45545',
      ...
      'prod.int.solution': '<strong>Soluția VAGOTECH:</strong> Sticlă interioară securizată sau laminată conform clasificării la impact EN&nbsp;12600 și comportamentului la foc EN&nbsp;45545. Finisaje clare, sablate sau nuanțate. Acoperiri anti-zgâriere. Execuții ușoare pentru eficiența vehiculului.',
      'prod.int.spec1': '<strong>Standard:</strong> EN&nbsp;12600 + EN&nbsp;45545 (foc & fum)',
      ...
      'prod.cust.solution': '<strong>Soluția VAGOTECH:</strong> Consultanță de inginerie completă de la desen la livrare. Orice formă, dimensiune sau execuție. Testare documentată și conformitate inclusiv EN&nbsp;45545 unde este aplicabil. Management de proiect dedicat pentru comenzi la scară de flotă.',
      ...
      'prod.cust.spec3': '<strong>Conformitate:</strong> Documentație EN completă incl. 45545',
      ...
      'comp.row2.label': 'EN 45545 (foc & fum)', 'comp.row2.vago': '✓ Execuții conforme',
      ...
      'comp.row6.label': 'Proximitate regională (RO/HU/RS/BG)', 'comp.row6.large': '✗ UK / FR', 'comp.row6.dist': '✗ SE / UK', 'comp.row6.vago': '✓ Timi&#537;oara, România',
      ...
      'cred.stat3': 'Livrare (față de 12–16 medie industrie)', 'cred.stat4': 'Standarde feroviare incl. 45545',
      ...
      'compl.en45545.label': 'Cerință Obligatorie Licitații UE',
      'compl.en45545.p': 'Comportament la foc și toxicitatea fumului — obligatoriu în licitațiile UE pentru operatori feroviari',
      ...
      'form.req.placeholder': 'Tipul vehiculului (locomotivă, EMU, tramvai, vagon), aplicația de sticlă, dimensiuni aproximative sau referință desen, număr vehicule, cerință EN 45545 (da/nu), termen de livrare dorit...',
      ...
      'footer.copyright': '© 2026 VAGOTECH by Glas Expert. Toate drepturile rezervate.  |  EN 15152  ·  EN 15153  ·  EN 12600  ·  EN 45545',
    }
  };
