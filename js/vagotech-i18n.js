...
(function () {
  ...
  var DICT = {
    en: {
      ...
      'hero.eyebrow': 'Omologat AFER · Railway Glass · Popești-Leordeni · Neubiberg',
      'hero.h1': 'VAGOTECH — Railway & Tramway Glass',
      'hero.subtitle': 'AFER Certified. Precision-Engineered. Delivered in 4–6 Weeks.',
      ...
      'strip.en15152': 'Front Glass', 'strip.en15153': 'Side & Door Glass',
      'strip.en12600': 'Impact Safety', 'strip.en45545': 'AFER Certified Romania',
      ...
      'market.cfr.h3': 'CFR Refurbishment & Maintenance',
      ...
      'prod.ws.h3': 'Front Glass',
      'prod.ws.challenge': '<strong>The challenge:</strong> Driver cab front glass on locomotives and EMUs needs crystal clarity, must withstand temperature extremes, resist high-energy impacts from ballast and debris, and hold structural integrity across decades of service.',
      'prod.ws.solution': '<strong>VAGOTECH solution:</strong> Laminated, heat-strengthened front glass with custom curvature to OEM cab geometry. Optional heating layer for de-icing, UV-protective and acoustic interlayers.',
      'prod.ws.spec1': '<strong>Certification:</strong> AFER · manufactured to European railway standards',
      ...
      'prod.sd.solution': '<strong>VAGOTECH solution:</strong> Tempered or laminated side and door glass with certified impact performance. Custom dimensions, curves and angles for any car type.',
      'prod.sd.spec1': '<strong>Certification:</strong> AFER · certified impact safety',
      ...
      'prod.int.solution': '<strong>VAGOTECH solution:</strong> Tempered or laminated interior glass with certified impact safety classification. Clear, frosted or tinted finishes. Anti-scratch coatings. Lightweight builds for vehicle efficiency.',
      'prod.int.spec1': '<strong>Certification:</strong> AFER · certified impact classification',
      ...
      'comp.row3.label': 'EU Railway Standards', 'comp.row3.vago': '✓ Compliant builds',
      ...
      'cred.stat3': 'Delivery (vs. 12–16 industry avg.)', 'cred.stat4': 'Only AFER-certified manufacturer',
      'compl.h2': 'Engineering & Compliance',
      'compl.subtitle': 'All VAGOTECH glass is engineered and documented to the standards that matter for EU railway operators',
      'compl.en15152.p': 'Front glass — driver cab on rail vehicles',
      'compl.en15153.p': 'Side & door glass — passenger windows on rail vehicles',
      'compl.en12600.p': 'Pendulum impact test & certified safety classification',
      ...
      'form.app.windscreen': 'Front glass (driver cab)', 'form.app.sidedoor': 'Side & door glass',
      'form.app.interior': 'Interior & partitions', 'form.app.custom': 'Custom / multiple applications',
      ...
      'footer.sol.ws': 'Front Glass', 'footer.sol.sd': 'Side & Door Glass',
      'footer.sol.int': 'Interior & Partitions', 'footer.sol.cust': 'Custom Rail Solutions',
      'footer.sol.privacy': 'Privacy Policy',
      'footer.copyright': '© 2026 VAGOTECH by Glas Expert. All rights reserved.  |  AFER Certified · Precision Railway Glass',
    },

    ro: {
      'nav.home': 'Acasă', 'nav.products': 'Produse', 'nav.compliance': 'Conformitate',
      'nav.about': 'Despre', 'nav.cta': 'Solicită Specificații',
      'hero.eyebrow': 'Omologat AFER · Sticlă Feroviară · Popești-Leordeni · Neubiberg',
      'hero.h1': 'VAGOTECH — Sticlă pentru Material Rulant',
      'hero.subtitle': 'Omologat AFER. Inginerie de precizie. Livrat în 4–6 săptămâni.',
      ...
      'strip.en15152': 'Geam Frontal', 'strip.en15153': 'Geam Lateral & Ușă',
      'strip.en12600': 'Siguranță la Impact', 'strip.en45545': 'Omologat AFER România',
      ...
      'market.cfr.h3': 'Refurbishing și Mentenanță CFR',
      ...
      'market.stb.p': 'STB București a contractat tramvaie noi de 36 de metri și derulează un program de retehnologizare pentru 323 de tramvaie V3A-M. Fiecare vehicul necesită geam frontal, lateral și de ușă pe un calendar fiabil.',
      ...
      'prod.ws.h3': 'Geam Frontal',
      'prod.ws.challenge': '<strong>Provocarea:</strong> Geamul frontal cabina mecanicului la locomotive și EMU-uri necesită claritate perfectă, trebuie să reziste la temperaturi extreme, să suporte impacturi cu energie ridicată de la balast și resturi, și să-și mențină integritatea structurală pe parcursul a zeci de ani de serviciu.',
      'prod.ws.solution': '<strong>Soluția VAGOTECH:</strong> Geam frontal laminat, termoîntărit, cu curbură personalizată la geometria cabinei OEM. Strat de încălzire opțional pentru dezghețare, folii de protecție UV și acustice.',
      'prod.ws.spec1': '<strong>Omologare:</strong> AFER · conform standarde feroviare europene',
      ...
      'prod.sd.solution': '<strong>Soluția VAGOTECH:</strong> Sticlă securizată sau laminată cu performanță la impact certificată. Dimensiuni, curbe și unghiuri personalizate pentru orice tip de vehicul.',
      'prod.sd.spec1': '<strong>Omologare:</strong> AFER · siguranță la impact certificată',
      ...
      'prod.int.solution': '<strong>Soluția VAGOTECH:</strong> Sticlă interioară securizată sau laminată cu clasificare certificată de siguranță la impact. Finisaje clare, sablate sau nuanțate. Acoperiri anti-zgâriere. Execuții ușoare pentru eficiența vehiculului.',
      'prod.int.spec1': '<strong>Omologare:</strong> AFER · clasificare siguranță la impact',
      ...
      'comp.row3.label': 'Standarde Feroviare UE', 'comp.row3.vago': '✓ Execuții conforme',
      ...
      'cred.stat3': 'Livrare (față de 12–16 medie industrie)', 'cred.stat4': 'Singurul producător omologat AFER',
      'compl.h2': 'Inginerie și Conformitate',
      'compl.subtitle': 'Toată sticla VAGOTECH este proiectată și documentată conform standardelor aplicabile pentru operatorii feroviari UE',
      'compl.en15152.p': 'Geam frontal — cabina mecanicului pe vehicule feroviare',
      'compl.en15153.p': 'Geam lateral & ușă — ferestre pasageri pe vehicule feroviare',
      'compl.en12600.p': 'Test de impact cu pendulul și clasificare certificată de siguranță',
      ...
      'form.app.windscreen': 'Geam frontal (cabina mecanicului)', 'form.app.sidedoor': 'Geam lateral și ușă',
      'form.app.interior': 'Geam interior și partiții', 'form.app.custom': 'Personalizat / aplicații multiple',
      ...
      'footer.sol.ws': 'Geam Frontal', 'footer.sol.sd': 'Geam Lateral și Ușă',
      ...
      'footer.copyright': '© 2026 VAGOTECH by Glas Expert. Toate drepturile rezervate.  |  Omologat AFER · Sticlă Feroviară de Precizie',
    }
  };
